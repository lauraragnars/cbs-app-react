...
const IconConfig = {
    ...
    [IconType.SEARCH]: {
        ...
        definition: (
            <>
                <Path fill="black" d="M8.333 0a8.334 8.334 0 100 16.667A8.966 8.966 0 0013 15.332L17.666 20 20 17.666 15.332 13a8.966 8.966 0 001.335-4.668A8.252 8.252 0 008.333 0zm0 3.333a5 5 0 11-5 5 4.911 4.911 0 015-5z" />            
            </>
        ),
    },
    [IconType.HOME]: {
...
export default function Icon({ type }: { type: IconType }) {
    ...
    return (
        <Svg viewBox={"0 0 " + config.viewBox}>
            {config.definition}
        </Svg>
    )
}
